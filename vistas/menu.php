...
<style>
    #miCuerpo {
      background-color: skyblue; /* Puedes cambiar el código de color según tus preferencias */
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/ventas.png" alt="" width="120px" height="150px"></a>
        </div>
